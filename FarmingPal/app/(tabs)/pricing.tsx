...
const CATEGORIES = [
  ...
  { label: 'Chemical',   color: '#FF6600', icon: 'spray-bottle', image: require('@/assets/images/Spayer-Greenv2.png'), href: '/(tabs)/submit-chem', subtitle: 'Herbicides, Fungicides & more' },
];
