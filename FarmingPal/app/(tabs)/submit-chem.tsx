...
const styles = StyleSheet.create({
  ...
  hero:                 { backgroundColor: '#FF6600', paddingTop: 24, paddingBottom: 28, paddingHorizontal: 20, alignItems: 'center' },
  heroTitle:            { fontSize: 28, fontWeight: '900', color: '#fff', marginBottom: 10 },
  heroSub:              { fontSize: 14, color: '#FFD4A8', textAlign: 'center', lineHeight: 22 },
